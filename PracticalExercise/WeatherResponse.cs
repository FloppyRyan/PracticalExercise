...
namespace PracticalExercise
{
    ...
    public partial class WeatherResponse
    {
        public static WeatherResponse FromJson(string json) => JsonConvert.DeserializeObject<WeatherResponse>(json, PracticalExercise.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WeatherResponse self) => JsonConvert.SerializeObject(self, PracticalExercise.Converter.Settings);
    }
